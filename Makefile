...
OBJECTS = minishell.o \
		  ...
		  functions/execution/heredoc.o functions/parsin/parsin_heardoc_counter.o functions/builtin/other_export.o \
		  functions/parsin/parsing_split_global_variables.o
